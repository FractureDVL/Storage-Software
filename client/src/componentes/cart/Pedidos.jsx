      ...
      <>
         <div className='container mx-auto mt-10 px-2'>
            ...
            <DataTable
               ...
               noDataComponent={'No has hecho ningún pedido.'}
            />
            <div className='text-center col-span-4 !ml-0'>
               <div className="border-blue-500 border-2 bg-blue-100 text-blue-700 rounded-md my-4 grid grid-cols-12 py-2">
                  ...
                  <p className="text-xs text-center col-span-11 max-sm:col-span-10 pr-4">
                     Por favor, Si tienes alguna pregunta o inquietud acerca de alguno de tus pedidos, por favor no dudes en ponerte en contacto a través de WhatsApp para obtener ayuda y aclarar tus inquietudes.
                  </p>
               </div>
